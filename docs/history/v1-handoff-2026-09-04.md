---
doc_type: history
purpose: "Historical record of the v1 hand-off notes (Sep 2026); not authoritative, see docs/README.md for current docs."
audience: both
...
> **Historical document.** Frozen as written on 2026-09-04. Facts here may be outdated; the current documentation is indexed in [docs/README.md](../README.md).
