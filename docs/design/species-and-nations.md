...
> Unverified: which caller (main process vs renderer) selects the `crack` animation and how it times the four frames against the hatch event; not confirmed in the files read for this doc.
